...
# The super() method allows us acces to the form. the super method
# is initialized with the .__init__(...)
# Location is Point field and point fields have a property called tuple
# which returns the coordinates of a Point as a tuple
# The if statement check if location is an instance if thats the case
# we return the logic below.
